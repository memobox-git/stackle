...
- User shares a URL to a job posting (e.g. "https://boards.greenhouse.io/foo/jobs/123" or any other career-page URL) → call tailor_for_jd_url(url=<the URL>). Narrate: "Fetching the JD..." while it runs.
